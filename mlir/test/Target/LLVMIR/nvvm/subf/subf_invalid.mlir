...
llvm.func @subf_invalid_sat_mode(%a : f16, %b : f16) -> f16 {
  ...
  %f1 = nvvm.subf %a, %b, sat = satfinite : f16
  llvm.return %f1 : f16
}
...
llvm.func @subf_invalid_f64_sat_ftz(%a : f64, %b : f64) -> f64 {
  // expected-error@+1 {{FTZ and saturation are not supported for additions/subtractions involving f64 type}}
  %f1 = nvvm.subf %a, %b, sat = sat, ftz : f64
  llvm.return %f1 : f64
}
...
llvm.func @subf_invalid_f16_rnd_mode(%a : f16, %b : f16) -> f16 {
  // expected-error@+1 {{only RN rounding mode is supported for f16 and vector<2xf16> additions/subtractions}}
  %f1 = nvvm.subf %a, %b, rnd = rm : f16
  llvm.return %f1 : f16
}
...
llvm.func @subf_invalid_v2f16_rnd_mode(%a : vector<2xf16>, %b : vector<2xf16>) -> vector<2xf16> {
  // expected-error@+1 {{only RN rounding mode is supported for f16 and vector<2xf16> additions/subtractions}}
  %f1 = nvvm.subf %a, %b, rnd = rm : vector<2xf16>
...
llvm.func @subf_invalid_bf16_rnd_mode(%a : bf16, %b : bf16) -> bf16 {
  // expected-error@+1 {{only RN rounding mode is supported for bf16 and vector<2xbf16> additions/subtractions}}
  %f1 = nvvm.subf %a, %b, rnd = rm : bf16
  llvm.return %f1 : bf16
}
...
llvm.func @subf_invalid_v2bf16_rnd_mode(%a : vector<2xbf16>, %b : vector<2xbf16>) -> vector<2xbf16> {
  // expected-error@+1 {{only RN rounding mode is supported for bf16 and vector<2xbf16> additions/subtractions}}
  %f1 = nvvm.subf %a, %b, rnd = rm : vector<2xbf16>
...
llvm.func @subf_invalid_bf16_sat_ftz(%a : bf16, %b : bf16) -> bf16 {
  // expected-error@+1 {{FTZ and saturation are not supported for bf16 and vector<2xbf16> additions/subtractions}}
  %f1 = nvvm.subf %a, %b, sat = sat, ftz : bf16
  llvm.return %f1 : bf16
}
...
llvm.func @subf_invalid_f16_ftz_no_sat(%a : f16, %b : f16) -> f16 {
  // expected-error@+1 {{FTZ with no saturation is not supported for f16 and vector<2xf16> additions/subtractions}}
  %f1 = nvvm.subf %a, %b, ftz : f16
  llvm.return %f1 : f16
}
