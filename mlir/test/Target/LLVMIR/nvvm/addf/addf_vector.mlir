...
llvm.func @addf_vector_f16_f16(%a : vector<2xf16>, %b : vector<2xf16>) -> vector<2xf16> {
  ...
  %f4 = nvvm.addf %f3, %f3, rnd = rn, sat = sat, ftz : vector<2xf16>
...
llvm.func @addf_vector_f32_f32_rn(%a : vector<2xf32>, %b : vector<2xf32>) -> vector<2xf32> {
  ...
  %f4 = nvvm.addf %f3, %f3, rnd = rn, ftz : vector<2xf32>
  %f5 = nvvm.addf %f4, %f4, rnd = rn, sat = sat, ftz : vector<2xf32>
...
llvm.func @addf_vector_f32_f32_rm(%a : vector<2xf32>, %b : vector<2xf32>) -> vector<2xf32> {
  ...
  %f3 = nvvm.addf %f2, %f2, rnd = rm, ftz : vector<2xf32>
  %f4 = nvvm.addf %f3, %f3, rnd = rm, sat = sat, ftz : vector<2xf32>
  llvm.return %f4 : vector<2xf32>
}
...
llvm.func @addf_vector_f32_f32_rp(%a : vector<2xf32>, %b : vector<2xf32>) -> vector<2xf32> {
  ...
  %f3 = nvvm.addf %f2, %f2, rnd = rp, ftz : vector<2xf32>
  %f4 = nvvm.addf %f3, %f3, rnd = rp, sat = sat, ftz : vector<2xf32>
  llvm.return %f4 : vector<2xf32>
}
...
llvm.func @addf_vector_f32_f32_rz(%a : vector<2xf32>, %b : vector<2xf32>) -> vector<2xf32> {
  ...
  %f3 = nvvm.addf %f2, %f2, rnd = rz, ftz : vector<2xf32>
  %f4 = nvvm.addf %f3, %f3, rnd = rz, sat = sat, ftz : vector<2xf32>
  llvm.return %f4 : vector<2xf32>
}
