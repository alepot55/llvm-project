...
llvm.func @fadd_f16_f16(%a : f16, %b : f16) -> f16 {
  ...
  %f4 = nvvm.addf %f3, %f3, rnd = rn, sat = sat, ftz : f16
  llvm.return %f4 : f16
}
...
llvm.func @fadd_f32_f32(%a : f32, %b : f32) -> f32 {
  ...
  %f4 = nvvm.addf %f3, %f3, rnd = rn, ftz : f32
  %f5 = nvvm.addf %f4, %f4, rnd = rn, sat = sat, ftz : f32
  %f6 = nvvm.addf %f5, %f5, rnd = rm : f32
  %f7 = nvvm.addf %f6, %f6, rnd = rm, sat = sat : f32
  %f8 = nvvm.addf %f7, %f7, rnd = rm, ftz : f32
  %f9 = nvvm.addf %f8, %f8, rnd = rm, sat = sat, ftz : f32
  %f10 = nvvm.addf %f9, %f9, rnd = rp : f32
  %f11 = nvvm.addf %f10, %f10, rnd = rp, sat = sat : f32
  %f12 = nvvm.addf %f11, %f11, rnd = rp, ftz : f32
  %f13 = nvvm.addf %f12, %f12, rnd = rp, sat = sat, ftz : f32
  %f14 = nvvm.addf %f13, %f13, rnd = rz : f32
  %f15 = nvvm.addf %f14, %f14, rnd = rz, sat = sat : f32
  %f16 = nvvm.addf %f15, %f15, rnd = rz, ftz : f32
  %f17 = nvvm.addf %f16, %f16, rnd = rz, sat = sat, ftz : f32
  llvm.return %f17 : f32
}
