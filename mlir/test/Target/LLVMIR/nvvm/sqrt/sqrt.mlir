...
llvm.func @sqrt_f32(%a : f32) -> f32 {
  ...
  %r5 = nvvm.sqrt %r4, rnd = rn, ftz : f32
  %r6 = nvvm.sqrt %r5, rnd = rz, ftz : f32
  %r7 = nvvm.sqrt %r6, rnd = rm, ftz : f32
  %r8 = nvvm.sqrt %r7, rnd = rp, ftz : f32
  llvm.return %r8 : f32
}
...
llvm.func @sqrt_approx(%a : f32) -> f32 {
  ...
  %r2 = nvvm.sqrt.approx %r1, ftz : f32
  llvm.return %r2 : f32
}
