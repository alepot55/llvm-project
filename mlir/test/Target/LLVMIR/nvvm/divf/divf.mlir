...
llvm.func @divf_f32(%a : f32, %b : f32) -> f32 {
  ...
  %r5 = nvvm.divf %r4, %r4, rnd = rn, ftz : f32
  %r6 = nvvm.divf %r5, %r5, rnd = rz, ftz : f32
  %r7 = nvvm.divf %r6, %r6, rnd = rm, ftz : f32
  %r8 = nvvm.divf %r7, %r7, rnd = rp, ftz : f32
  llvm.return %r8 : f32
}
...
llvm.func @divf_approx(%a : f32, %b : f32) -> f32 {
  ...
  %r1 = nvvm.divf %a, %b, approx : f32
  %r2 = nvvm.divf %r1, %r1, ftz, approx : f32
  llvm.return %r2 : f32
}
...
llvm.func @divf_full(%a : f32, %b : f32) -> f32 {
  ...
  %r1 = nvvm.divf %a, %b, full : f32
  %r2 = nvvm.divf %r1, %r1, ftz, full : f32
  llvm.return %r2 : f32
}
