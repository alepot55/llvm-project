...
func.func @nvvm_cos_ftz_f32(%arg0: f32) -> f32 {
  // CHECK: nvvm.cos {{.*}}, ftz : f32
  %0 = nvvm.cos %arg0, ftz : f32
  return %0 : f32
}
...
func.func @nvvm_sin_ftz_f32(%arg0: f32) -> f32 {
  // CHECK: nvvm.sin {{.*}}, ftz : f32
  %0 = nvvm.sin %arg0, ftz : f32
  return %0 : f32
}
...
func.func @nvvm_lg2_ftz_f32(%arg0: f32) -> f32 {
  // CHECK: nvvm.log2 {{.*}}, ftz : f32
  %0 = nvvm.log2 %arg0, ftz : f32
  return %0 : f32
}
...
func.func @nvvm_ex2_ftz_f32(%arg0: f32) -> f32 {
  // CHECK: nvvm.ex2 {{.*}}, ftz : f32
  %0 = nvvm.ex2 %arg0, ftz : f32
  return %0 : f32
}
